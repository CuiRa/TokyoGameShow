...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    {
        [SerializeField] private bool m_IsWalking;                //歩いているか
        [SerializeField] private float m_WalkSpeed;               //歩く速さ
        [SerializeField] private float m_RunSpeed;                //走る速さ
        [SerializeField] [Range(0f, 1f)] private float m_RunstepLenghten;             //走行時の揺れ
        [SerializeField] private float m_JumpSpeed;               //ジャンプ力ぅ...ですかねぇ
        [SerializeField] private float m_StickToGroundForce;      //着地補正?
        [SerializeField] private float m_GravityMultiplier;       //重力補正?
        [SerializeField] private MouseLook m_MouseLook;           //
        [SerializeField] private bool m_UseFovKick;               //
        [SerializeField] private FOVKick m_FovKick = new FOVKick();             //
        [SerializeField] private bool m_UseHeadBob;               //歩きのカメラの揺れ
        [SerializeField] private CurveControlledBob m_HeadBob = new CurveControlledBob();             //
        [SerializeField] private LerpControlledBob m_JumpBob = new LerpControlledBob();             //
        [SerializeField] private float m_StepInterval;            //足音 ジャンプ 着地音
        ...
        private void Start()
        {
            ...
            _child = transform.FindChild("FirstPersonCharacter").gameObject;
...
//            m_IsWalking = !Input.GetKey(KeyCode.LeftShift);
            m_IsWalking = !Input.GetButton("Dash");     //走る
#endif
        ...
        private void RotateView()      //カメラ制御
        {
            //            m_MouseLook.LookRotation (transform, m_Camera.transform);   //マウスで視点変更
